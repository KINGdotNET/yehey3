...
import customOperations from './operations/custom-operations';
import helperOperations from './operations';
...
export const validateRequired = (type, query) => {
  const errors = [];
...
export const validate = async (type, query) => {
  const snakeCaseType = changeCase.snakeCase(type);
  // const snakeCaseType = type;
...
export const normalize = async (type, query) => {
  const snakeCaseType = changeCase.snakeCase(type);
  // const snakeCaseType = type;
