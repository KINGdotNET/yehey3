...
class DiscoverPosts extends React.Component {
    static propTypes = {
  ...
  componentDidMount() {
    ...
    const initialUsers = allAccounts.sort((a,b) => b.post_count - a.post_count).slice(0, displayLimit);
  ...
  handleLoadMore = () => {
    ...
    const moreUsers = allAccounts.sort((a,b) => b.post_count - a.post_count).slice(moreUsersStartIndex, moreUsersStartIndex + displayLimit);
    this.setState({
